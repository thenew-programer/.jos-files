...
-- Quit and Save
keymap("n", "<leader>w", ":w<CR>", nopts)
keymap("n", "<leader>q", ":q<CR>", nopts)
keymap("n", "<leader>qqq", ":q!<CR>", nopts)
keymap("n", "<leader>os", ":source %<CR>", nopts)
...
keymap("n", "<leader>tg", ":Telescope current_buffer_fuzzy_find<CR>", opts)
-- keymap("n", "<leader>r", ":Telescope registers <CR>", opts)
keymap("n", "<C-m>", ":Telescope man_pages<CR>", opts)
