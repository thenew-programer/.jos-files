...
static const int smartgaps_fact =
    2; /* gap factor when there is only one client; 0 = no gaps, 3 = 3x outer
          gaps */
...
static const char *fonts[] = {
    "FiraCode Nerd Font:size=10:style=bold:antialias=true:autohint=true"};
    ...
    RULE(.wintype = WTYPE "DIALOG",
        ...
        RULE(.wintype = WTYPE "TOOLBAR",
            ...
            RULE(.class = "Gimp", .isfloating = 1,
                 .tags = 1 << 3) RULE(.class = "Lxappearance", .isfloating = 1)
                RULE(.class = "File-roller",
                     .isfloating = 1) RULE(.class = "obs", .monitor = 1)
...
static const Layout layouts[] = {
    ...
    {"[M]", monocle},  {"TTT", bstack}, {"|M|", centeredmaster},
    {"[\\]", dwindle}, {"HHH", grid},   {NULL, NULL},
};
...
//     "eww",   "open-many", "blur",   "profile", "system",   "clock", "uptime",
//     "music", "github",    "reddit", "lor",     "youtube",  "twitch",
//     "weather", "apps",  "logout",    "sleep",  "reboot",  "poweroff",
//     "folders", NULL};
...
static Key keys[] = {
    ...
    {MODKEY, XK_w, spawn, {.v = wireshark}},
    {MODKEY, XK_j, focusstack, {.i = +1}},
    {MODKEY, XK_k, focusstack, {.i = -1}},
    {MODKEY | ShiftMask, XK_s, swapfocus, {.i = -1}},
    ...
    // MODKEY|Mod1Mask|ShiftMask,    XK_u,          incrgaps,               {.i
    // = -1 } }, { MODKEY|Mod1Mask,              XK_i,          incrigaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_i,          incrigaps, {.i =
    // -1 } }, { MODKEY|Mod1Mask,              XK_o,          incrogaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_o,          incrogaps, {.i =
    // -1 } }, { MODKEY|Mod1Mask,              XK_6,          incrihgaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_6,          incrihgaps, {.i =
    // -1 } }, { MODKEY|Mod1Mask,              XK_7,          incrivgaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_7,          incrivgaps, {.i =
    // -1 } }, { MODKEY|Mod1Mask,              XK_8,          incrohgaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_8,          incrohgaps, {.i =
    // -1 } }, { MODKEY|Mod1Mask,              XK_9,          incrovgaps, {.i =
    // +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_9,          incrovgaps, {.i =
    ...
    {MODKEY | ShiftMask,
     XK_e,
     spawn,
     {.v = eww_close}}, /* Close every eww instance */
    {MODKEY, XK_d, spawn, SHCMD("rofi -show drun -modi drun")},
    {0, XK_ISO_Next_Group, spawn,
     SHCMD("pkill -RTMIN+10 dwmblocks")}, /* keyboard indicator */
};
